...
| :------------- | :------------- | :-------- | :-----: | :-----: | :-----: | :-----: | 
| MPLight | [Toward A Thousand Lights: Decentralized Deep Reinforcement Learning for Large-Scale Traffic Signal Control](https://chacha-chen.github.io/files/chacha-AAAI2020.pdf) | AAAI'2020 | A combination of PressLight and FRAP  | - |[Demo](https://traffic-signal-control.github.io/a-thousand-lights.html) | -|
...
| MetaLight |  [MetaLight: Value-based Meta-reinforcement Learning for Traffic Signal Control](https://uploads.strikinglycdn.com/files/f8450f43-19af-48ec-831a-bec87f1ec038/Metalight-AAAI-20.pdf) |AAAI'2020 | Meta-RL for traffic signal control] | [Code](https://github.com/zxsRambo/metalight) |-|-|
